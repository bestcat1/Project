...
/**
 * Generated class for the SelectweancalfPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-selectweancalf',
  templateUrl: 'selectweancalf.html',
})
export class SelectweancalfPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SelectweancalfPage');
  }
  ...
  wc(a){
    this.navCtrl.push("WeancalfPage",{user:this.user,id:a});
  }
}
